...
public class NavigationViewModel extends AndroidViewModel {
  ...
  private void playVoiceAnnouncement(Milestone milestone) {
    if (milestone instanceof VoiceInstructionMilestone) {
      ...
      announcement = navigationViewEventDispatcher.onNewSpeechAnnouncement(announcement);
  ...
  private void updateBannerInstruction(RouteProgress routeProgress, Milestone milestone) {
    if (milestone instanceof BannerInstructionMilestone) {
      ...
      instructions = navigationViewEventDispatcher.onNewBannerInstructions(instructions);
